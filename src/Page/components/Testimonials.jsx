                    ...
                    <div>
                        ...
                        >
                            {testimonials.map((t, idx) => {
                                ...
                                return (
                                    <SwiperSlide key={idx}>
                                        <div className="bg-white rounded-2xl shadow-lg p-6 text-center flex flex-col items-center hover:shadow-xl transition-transform duration-300 hover:scale-105">
                                            {/* Profile Image */}
                                            <img
                                                src={t.image}
                                                alt={`Photo of ${t.name}`}
